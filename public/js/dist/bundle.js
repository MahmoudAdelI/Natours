    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data) {
            (0, _alert.default)('success', 'Signed up successfully');
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.default)('error', _t.response.data.message);
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _axios.default.post('http://localhost:3000/api/v1/users/forgot-password', {
            email: email
          });
        case 1:
          res = _context2.v;
          if (res.data) {
            (0, _alert.default)('success', 'Check your email');
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.default)('error', _t2.response.data.message);
        case 3:
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(data, token) {
    var res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.p = 0;
          _context3.n = 1;
          return _axios.default.patch("http://localhost:3000/api/v1/users/reset-password/".concat(token), data);
        case 1:
          res = _context3.v;
          if (res.data) {
            (0, _alert.default)('success', 'Password has been resetted successfully');
            window.location.assign('/');
          }
          _context3.n = 3;
          break;
        case 2:
          _context3.p = 2;
          _t3 = _context3.v;
          (0, _alert.default)('error', _t3.response.data.message);
        case 3:
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.p = 0;
          _context4.n = 1;
          return _axios.default.post('http://localhost:3000/api/v1/users/login', data);
        case 1:
          res = _context4.v;
          if (res.data) {
            (0, _alert.default)('success', 'Logged In');
            window.location.assign('/');
          }
          _context4.n = 3;
          break;
        case 2:
          _context4.p = 2;
          _t4 = _context4.v;
          (0, _alert.default)('error', _t4.response.data.message);
        case 3:
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setText("Day ".concat(loc.day, ": ").concat(loc.description)).addTo(map);
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          url = type === 'data' ? 'http://localhost:3000/api/v1/users/me' : 'http://localhost:3000/api/v1/users/update-password';
          _context.n = 1;
          return _axios.default.patch(url, data);
        case 1:
          res = _context.v;
          if (res.data) {
            (0, _alert.default)('success', "".concat(type === 'data' ? 'Data' : 'Password', " has been updated successfully"));
...
var _default = exports.default = updateUserData;
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId, stripe) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
...
var _updateUserData = _interopRequireDefault(require("./updateUserData.js"));
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            ...
            _context5.n = 1;
            return (0, _updateUserData.default)(form, 'data');
          case 1:
